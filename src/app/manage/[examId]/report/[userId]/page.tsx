  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        else router.push(`/manage/${examId}`);
      } catch { router.push(`/manage/${examId}`); }
      ...
      <header className="bg-[#0d1117] border-b border-blue-500/10 px-4 sm:px-6 py-4 sticky top-0 z-20">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            <button onClick={() => router.push(`/manage/${examId}`)} className="p-2 rounded-lg text-gray-400 hover:text-white hover:bg-white/5"><ArrowLeft size={20} /></button>
